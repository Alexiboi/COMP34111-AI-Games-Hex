...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-p1",
        "--player1",
        default="agents.Group14.MyAgent_dan MyAgent_dan", #"agents.Group14.MyAgent MyAgent"
        type=str,
    ...
    parser.add_argument(
        "-p1Name",
        "--player1Name",
        default="MyAgent_dan", #"Was Group 14"
        type=str,
    ...
    parser.add_argument(
        "-p2",
        "--player2",
        default="agents.Group14.MyAgent_dan2 MyAgent_dan2",
        type=str,
